...
//]]>
	...
	<meta name="keywords" content="admin, dashboard , SPAM SMS">
	<meta name="author" content="DIGGORY">
	...
	<!-- PAGE TITLE HERE -->
	<title>SPAM SMS FREE</title>
	
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/png" href="https://i.imgur.com/6RoGP5J.png">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="https://dichvugiare.site/" class="brand-logo">
				...
				<ul class="metismenu" id="menu">
					<li class="dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<img src=" https://i.imgur.com/7pdgun4.png" width="20" alt="">
							<div class="header-info ms-3">
								<span class="font-w600 ">Hi,<b>TRÙM LÙA LÀ MÀY </b></span>
								<small class="text-end font-w400">trumlua@gmail.com</small>
							</div>
						</a>
						<div class="dropdown-menu dropdown-menu-end">
							<a href="https://zalo.me/0562736657" class="dropdown-item ai-icon">
								<svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
								<span class="ms-2">Profile admin  </span>
							</a>
							<a href="https://zalo.me/0562736657" class="dropdown-item ai-icon">
								<svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
								<span class="ms-2">Inbox Zalo </span>
							</a>
							<a href="https://zalo.me/0562736657" class="dropdown-item ai-icon">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="/sv1.php">SERVER 1-FREE</a></li>
					    	<li><a href="/">SERVER 2 </a></li> 
							
							
						</ul>
				<div class="copyright">
					<p><strong>DIGGORY</strong> © 2025 All Rights Reserved</p>
					<p class="fs-12">Made with <span class="heart"></span> by DIGGORY </p>
				</div>
			</div>
        </div>
        <!--**********************************
						...
						<div class="card bg-warning invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">Tổng số yêu cầu spam  </span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">Tổng só yêu cầu spam thành công</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-info invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">Tổng số yêu cầu spam thất bại</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-secondary invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">Tổng só yêu cầu spam đang chờ xử lý</span>
								</div>
							</div>
						</div>
					</div>
...
<form action="server1.php?" method="get"> <!-- file spam để dóng mẫu-->
    <div class="card">
        <div class="card-body">
<h5>SDT:</h5> <input type="text" name="sdt"><br>
 <button <input type="submit" class="btn btn-success">GỬI</button>
</form>
                                  
                           <!-- code by DIGGORY 0562736657 ZALO -->
										 <!--**********************************
                                             phần chèn fr om spam 
                                         ***********************************-->
